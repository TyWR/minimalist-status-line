...
call s:check_defined('g:bufferline_show_bufnr', 0)
call s:check_defined('g:bufferline_fname_mod', ':t')
call s:check_defined('g:bufferline_inactive_highlight', 'TabLine')
call s:check_defined('g:bufferline_active_highlight', 'TabLineSel')
call s:check_defined('g:bufferline_rotate', 0)
call s:check_defined('g:bufferline_fixed_index', 0)
